...
public class SofimaChecker extends FilterChecker {
	...
	private static final ServerConnectionHandler serverConnectionHandler = new JSBasedConnectionHandler(SERVER_URL_STRING, INPUT_FIELD_ID, SEARCH_BUTTON_ID);
	
	public SofimaChecker() {
		super(CHECKER_NAME, serverConnectionHandler, SUCCESS_RESPONSE, BLOCKED_BY_SERVER_RESPONSE);
	}
