...
// TODO input by name + search button by ..?
public class FiltrationGroupChecker extends FilterChecker {
	private static final String CHECKER_NAME = "FiltrationGroup";
	private static final String SERVER_URL_STRING = "https://www.filtrationgroup.com/content/mahle-reference";
	private static final String SUCCESS_RESPONSE = "";
	private static final String BLOCKED_BY_SERVER_RESPONSE = "some_blocked_by_server_response";
	private static final String INPUT_FIELD_NAME = "";
	private static final String SEARCH_BUTTON_NAME = "";
	private static final ServerConnectionHandler SERVER_CONNECTION_HANDLER = new JSBasedConnectionHandler(SERVER_URL_STRING, INPUT_FIELD_NAME, SEARCH_BUTTON_NAME);
	
	public FiltrationGroupChecker() {
